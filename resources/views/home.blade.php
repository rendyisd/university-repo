            ...
            <div class="col-lg-9">
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <select class="form-select" name="type" required>
                                    ...
                                    <option value="author">People</option>
                                </select>
                        ...
                        <div class="col">
                            ...
                            <div class="card mb-4 w-100 panel-browse">
                                ...
                                <div class="card-body d-grid gap-2">
                                    <div class="row">
                                        <div class="col px-1">
                                            <a href="{{ route('browse.faculty') }}"
                                                class="btn btn-secondary w-100">Division</a>
                                        </div>
                                        <div class="col px-1">
                                    ...
                                    <div class="row">
                                        <div class="col px-1">
                                            <a href="{{ route('browse.type') }}" class="btn btn-secondary w-100">Document
                                                Type</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <table class="table table-striped table-bordered">
                        <tbody>
                            <tr>
                                <th scope="col" class="fw-bold">Related</th>
                                        ...
                                        <p class="col-bibliography-sub">
                                            @foreach ($document->author as $author)
                                                @php
                                                    ...
                                                    $authorName =
                                                        $nameArr[count($nameArr) - 1] .
                                                        ', ' .
                                                        implode(' ', array_slice($nameArr, 0, count($nameArr) - 1));
                                                @endphp
